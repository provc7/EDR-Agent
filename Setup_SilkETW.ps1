...
$collectors = @(
    @{
        ...
        CollectorType = "user"
        UserKeywords  = "0x8000000000000000"
        OutputType    = "file"
        FileName      = "dns.json"
    },
    @{
    ...
    @{
        ...
        UserKeywords  = "0x2038"
        OutputType    = "file"
        FileName      = "dotnet.json"
    },
    @{
        Comment       = "WMI Activity"
    ...
    @{
        ...
        UserKeywords  = "0x120"
        OutputType    = "file"
        FileName      = "kernel_file.json"
    },
    @{
        Comment       = "Kernel Registry"
        ProviderName  = "Microsoft-Windows-Kernel-Registry"
        CollectorType = "user"
        UserKeywords  = "0x301"
        OutputType    = "file"
        FileName      = "kernel_registry.json"
    }
